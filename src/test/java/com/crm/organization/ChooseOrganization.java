...
public static void main(String[] args) throws Throwable {
	...
	System.out.println("==it supports only two browsers==");
		...
		Set<String> allWindowIds = driver.getWindowHandles();
		 ArrayList<String> allWindowList = new ArrayList<String>(allWindowIds);
		 driver.switchTo().window(allWindowList.get(1));
		 //String parentWindow = driver.getWindowHandle();
		// driver.switchTo().window(parentWindow);
		 
		 System.out.println(driver.getTitle());
		List<WebElement> listofOrganizationName = driver.findElements(By.xpath("//tr[@bgcolor='white']"));
		
		 for (WebElement organizationsNames : listofOrganizationName) {
			 System.out.println(organizationsNames.getText());
			
		}
		
		 driver.findElement(By.id("search_txt")).sendKeys("vijju");
		 driver.findElement(By.name("search")).click();
		 driver.findElement(By.linkText("vijju")).click();
